              ...
              <label className='my-3' htmlFor='Series'>
                ...
                {lists?.data.length > 0 && (
                  <select
                    ...
                    value={listId}
                  >
                    <option defaultValue>Select a List</option>
                    {lists?.data.map(item => (
      ...
      {modalIsOpen && (
        <ConfirmationModal>
          ...
          <h2 className='text-2xl'>
            You must {lists.data.length > 0 ? 'select' : 'create'} at least one
            collection before you begin adding books.
          </h2>
          <button
