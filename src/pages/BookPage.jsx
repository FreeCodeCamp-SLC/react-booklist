...
export default function BookPage () {
  ...
  const [readingStatusId, setReadingStatusId] = useState(book.reading_status_id)
  const [listId, setListId] = useState(book.list_id)
  const [dateStarted, setDateStarted] = useState(convertDate(book.date_started))
        ...
        >
          <>
            <h2 className='text-2xl'>
              Are you sure you want to delete the book &quot{title}&quot?
            </h2>
            <button
